...
export function PageHeader({ eyebrow, title, description, actions, children, icon, tone = "blue" }: { eyebrow?: ReactNode; title: ReactNode; description?: ReactNode; actions?: ReactNode; children?: ReactNode; icon?: IconName; tone?: Tone }) {
  return (

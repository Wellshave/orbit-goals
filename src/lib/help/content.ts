...
export const HELP: Record<string, HelpTopic> = {
  ...
  people: {
    id: "people", route: "/me", title: "Your personal dashboard", visual: "people",
    summary: "Every person has one dashboard that answers three questions in a few seconds: where do I stand, what needs attention today, and what is my next meaningful step. Open yours from My dashboard in the menu; open a colleague’s from People.",
    steps: [
      "The Momentum Ribbon at the top summarises the period in one line: goals on track, KPI check-ins, your next milestone and your contribution points compared with the previous period. The part that needs you most gently pulses.",
      "Focus right now shows the one goal that matters most, why it needs attention and how far the next milestone is. Other goals that need attention are one click away.",
      "Next step lists at most three concrete actions with a time estimate, such as a check-in, a reply to a mention or logging a training. It disappears when there is nothing to do.",
      "My progress shows your personal goals as calm rows with a progress track and milestone dots; Momentum next to it links your next milestones with the routines that get you there.",
      "Together with the team shows the team and company goals you contribute to, including your own updates and who worked on them recently, next to a short timeline of grouped activity.",
      "Private goals stay private: on a colleague’s dashboard you only see what you are allowed to see, and you can send a message, a high-five or thanks from the header.",
    ],
    tips: ["KPIs are visible to everyone by design, so a colleague’s dashboard shows their KPIs; only goals have visibility settings.", "Use the period bar to look back at a week, month, quarter or year. The score breakdown lives on the scoreboard."],
    tour: [
      { target: "momentum-ribbon", text: "Your period at a glance. The pulsing part is what needs you most right now.", action: "hover", hold: 600 },
      { target: "focus", text: "The one goal that matters most right now, with the distance to the next milestone.", action: "hover", hold: 600 },
      { target: "my-progress", text: "Your personal goals as a calm list, with your next milestones and routines on the right.", action: "hover", hold: 600 },
    ],
  },
  settings: {
